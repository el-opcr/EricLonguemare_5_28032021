...
var _urlAssetsImagesTeddy_1JpgAsWebpWidth = require("url:./assets/images/teddy_1.jpg?as=webp&width=250");
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _urlAssetsImagesTeddy_1JpgAsWebpWidthDefault = _parcelHelpers.interopDefault(_urlAssetsImagesTeddy_1JpgAsWebpWidth);
...
fetch(entryPoint).then(response => response.json()).then(datas => {
  datas.forEach(row => {
...
function displayBears(myBear) {
  ...
  myCardPicture.src = myBear.imageUrl + "?as=webp&width=250";
  _urlAssetsImagesTeddy_1JpgAsWebpWidthDefault.default;
...
},{"url:./assets/images/teddy_1.jpg?as=webp&width=250":"2efQh","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2efQh":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + "teddy_1.464fb42b.webp"
...
},{}]},["3Imd1","5rkFb"], "5rkFb", "parcelRequirea68b")
